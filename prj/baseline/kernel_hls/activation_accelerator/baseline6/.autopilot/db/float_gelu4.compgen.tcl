...
set name activation_accelerator_fmul_32ns_32ns_32_3_full_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {fmul} IMPL {fulldsp} LATENCY 2 ALLOW_PRAGMA 1
}
...
set name activation_accelerator_fexp_32ns_32ns_32_5_med_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {fexp} IMPL {meddsp} LATENCY 4 ALLOW_PRAGMA 1
}
