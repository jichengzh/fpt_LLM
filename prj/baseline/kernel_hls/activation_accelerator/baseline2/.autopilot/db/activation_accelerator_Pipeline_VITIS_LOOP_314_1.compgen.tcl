...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename x \
    op interface \
    ports { x_address0 { O 11 vector } x_ce0 { O 1 bit } x_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename y \
    op interface \
    ports { y_address0 { O 15 vector } y_ce0 { O 1 bit } y_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename x_mask \
    op interface \
    ports { x_mask_address0 { O 15 vector } x_mask_ce0 { O 1 bit } x_mask_we0 { O 1 bit } x_mask_d0 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'x_mask'"
}
}
