...
module activation_accelerator_activation_accelerator_Pipeline_VITIS_LOOP_499_4 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [15:0] buf2_load_reg_146;
wire   [63:0] i_3_cast_fu_115_p1;
wire    ap_block_pp0_stage0_01001;
reg   [15:0] i_3_fu_54;
wire   [15:0] add_ln499_fu_109_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln499_fu_103_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln499_fu_103_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln499_fu_109_p2 = (ap_sig_allocacmp_i + 16'd1);
...
assign buf2_address0 = i_3_cast_fu_115_p1;

assign i_3_cast_fu_115_p1 = ap_sig_allocacmp_i;

assign icmp_ln499_fu_103_p2 = ((ap_sig_allocacmp_i == 16'd49152) ? 1'b1 : 1'b0);
...
assign m_axi_gmem2_WDATA = buf2_load_reg_146;
...
endmodule //activation_accelerator_activation_accelerator_Pipeline_VITIS_LOOP_499_4
