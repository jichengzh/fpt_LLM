...
module activation_accelerator_activation_accelerator_Pipeline_VITIS_LOOP_1118_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [15:0] i_fu_52;
wire   [15:0] add_ln1118_fu_104_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln1118_fu_98_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln1118_fu_98_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln1118_fu_104_p2 = (ap_sig_allocacmp_i_2 + 16'd1);
...
assign i_cast_fu_115_p1 = i_2_reg_126_pp0_iter1_reg;

assign icmp_ln1118_fu_98_p2 = ((ap_sig_allocacmp_i_2 == 16'd49152) ? 1'b1 : 1'b0);
...
endmodule //activation_accelerator_activation_accelerator_Pipeline_VITIS_LOOP_1118_1
