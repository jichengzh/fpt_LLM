...
wire   [0:0] tmp_6_fu_146_p3;
wire   [15:0] select_ln130_fu_154_p3;
wire   [0:0] tmp_7_fu_168_p3;
...
assign expb_fu_92_p3 = {{tmp_4_fu_82_p4}, {7'd0}};
...
assign select_ln130_fu_154_p3 = ((tmp_6_fu_146_p3[0:0] == 1'b1) ? 16'd65535 : 16'd32768);

assign select_ln131_fu_176_p3 = ((tmp_7_fu_168_p3[0:0] == 1'b1) ? 16'd65535 : 16'd32768);

assign select_ln135_fu_196_p3 = ((icmp_ln135_fu_190_p2[0:0] == 1'b1) ? b : a);

assign tmp_4_fu_82_p4 = {{b[14:7]}};

assign tmp_6_fu_146_p3 = a[32'd15];

assign tmp_7_fu_168_p3 = b[32'd15];
