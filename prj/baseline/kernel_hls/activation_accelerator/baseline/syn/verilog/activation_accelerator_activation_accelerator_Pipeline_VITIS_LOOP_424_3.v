...
wire   [63:0] zext_ln424_fu_102_p1;
reg   [63:0] zext_ln424_reg_123;
wire    ap_CS_fsm_state2;
wire   [0:0] icmp_ln424_fu_90_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        i_fu_32 <= 16'd0;
    end else if (((icmp_ln424_fu_90_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln424_fu_90_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        zext_ln424_reg_123[15 : 0] <= zext_ln424_fu_102_p1[15 : 0];
    end
end
...
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b0)) | ((icmp_ln424_fu_90_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((icmp_ln424_fu_90_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
assign add_ln424_fu_96_p2 = (i_fu_32 + 16'd1);
...
assign buf0_address0 = zext_ln424_fu_102_p1;

assign buf1_address0 = zext_ln424_fu_102_p1;

assign buf2_address0 = zext_ln424_reg_123;

assign buf2_d0 = grp_bf16add_fu_75_ap_return;

assign grp_bf16add_fu_75_ap_start = grp_bf16add_fu_75_ap_start_reg;

assign icmp_ln424_fu_90_p2 = ((i_fu_32 == 16'd32768) ? 1'b1 : 1'b0);

assign zext_ln424_fu_102_p1 = i_fu_32;

always @ (posedge ap_clk) begin
    zext_ln424_reg_123[63:16] <= 48'b000000000000000000000000000000000000000000000000;
end
