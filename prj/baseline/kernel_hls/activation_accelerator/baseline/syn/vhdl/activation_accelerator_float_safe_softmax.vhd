...
attribute shreg_extract : string;
    ...
    signal exp_x_address0 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal grp_float_safe_softmax_Pipeline_softmax_loop_1_fu_40_x_address0 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal grp_float_safe_softmax_Pipeline_softmax_loop_2_fu_48_x_address0 : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_float_safe_softmax_Pipeline_softmax_loop_2_fu_48_x_ce0 : STD_LOGIC;
    signal grp_float_safe_softmax_Pipeline_softmax_loop_2_fu_48_exp_x_address0 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal grp_float_safe_softmax_Pipeline_softmax_loop_3_fu_57_exp_x_address0 : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_float_safe_softmax_Pipeline_softmax_loop_3_fu_57_exp_x_ce0 : STD_LOGIC;
    signal grp_float_safe_softmax_Pipeline_softmax_loop_3_fu_57_buf2_address0 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
    ...
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state8 => 
                if (((grp_float_safe_softmax_Pipeline_softmax_loop_3_fu_57_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state8))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state8;
                end if;
    ...
    begin
        if ((((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_0)) or ((grp_float_safe_softmax_Pipeline_softmax_loop_3_fu_57_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state8)))) then 
    ...
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state8)) then 
            ...
            exp_x_address0 <= "XXXXXXXXXXXXXXXX";
        end if; 
    end process;
    ...
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state1)) then 
            x_address0 <= ap_const_lv64_0(16 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
            x_address0 <= grp_float_safe_softmax_Pipeline_softmax_loop_2_fu_48_x_address0;
