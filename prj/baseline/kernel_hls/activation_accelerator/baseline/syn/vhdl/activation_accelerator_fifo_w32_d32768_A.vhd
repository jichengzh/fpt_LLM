...
entity activation_accelerator_fifo_w32_d32768_A is
    generic (
...
architecture arch of activation_accelerator_fifo_w32_d32768_A is

    -- component
    component activation_accelerator_fifo_w32_d32768_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
...
begin
----------------------- Instantiation -----------------------
    U_activation_accelerator_fifo_w32_d32768_A_ram : activation_accelerator_fifo_w32_d32768_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity activation_accelerator_fifo_w32_d32768_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 32;
        ADDR_WIDTH  : integer := 15;
...
architecture arch of activation_accelerator_fifo_w32_d32768_A_ram is
