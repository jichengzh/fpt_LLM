...
entity activation_accelerator_activation_accelerator_Pipeline_VITIS_LOOP_499_4 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of activation_accelerator_activation_accelerator_Pipeline_VITIS_LOOP_499_4 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln499_fu_103_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal buf2_load_reg_146 : STD_LOGIC_VECTOR (15 downto 0);
    signal i_3_cast_fu_115_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal i_3_fu_54 : STD_LOGIC_VECTOR (15 downto 0);
    signal add_ln499_fu_109_p2 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln499_fu_103_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    i_3_fu_54 <= add_ln499_fu_109_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    i_3_fu_54 <= ap_const_lv16_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    add_ln499_fu_109_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i) + unsigned(ap_const_lv16_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln499_fu_103_p2)
    begin
        if (((icmp_ln499_fu_103_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_sig_allocacmp_i_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, i_3_fu_54, ap_loop_init)
    begin
    ...
    buf2_address0 <= i_3_cast_fu_115_p1(16 - 1 downto 0);
    ...
    i_3_cast_fu_115_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i),64));
    icmp_ln499_fu_103_p2 <= "1" when (ap_sig_allocacmp_i = ap_const_lv16_C000) else "0";
    ...
    m_axi_gmem2_WDATA <= buf2_load_reg_146;
