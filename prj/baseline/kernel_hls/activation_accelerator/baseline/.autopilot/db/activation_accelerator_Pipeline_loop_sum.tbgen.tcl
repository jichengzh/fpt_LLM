set moduleName activation_accelerator_Pipeline_loop_sum
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {activation_accelerator_Pipeline_loop_sum}
...
set portList { 
	...
	{ sum_sq_out sc_out sc_lv 32 signal 4 } 
	{ sum_sq_out_ap_vld sc_out sc_logic 1 outvld 4 } 
