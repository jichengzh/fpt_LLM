...
entity activation_accelerator_fifo_w512_d64_A is
    generic (
...
architecture arch of activation_accelerator_fifo_w512_d64_A is

    -- component
    component activation_accelerator_fifo_w512_d64_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
...
begin
----------------------- Instantiation -----------------------
    U_activation_accelerator_fifo_w512_d64_A_ram : activation_accelerator_fifo_w512_d64_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity activation_accelerator_fifo_w512_d64_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 512;
        ADDR_WIDTH  : integer := 6;
...
architecture arch of activation_accelerator_fifo_w512_d64_A_ram is
