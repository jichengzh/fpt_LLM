set moduleName activation_accelerator_Pipeline_VITIS_LOOP_1174_3
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {activation_accelerator_Pipeline_VITIS_LOOP_1174_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem2 int 16 regular {axi_master 1}  }
	{ sext_ln1174 int 63 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem2", "interface" : "axi_master", "bitwidth" : 16, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "out_r","offset": { "type": "dynamic","port_name": "out_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln1174", "interface" : "wire", "bitwidth" : 63, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln1174 sc_in sc_lv 63 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln1174", "direction": "in", "datatype": "sc_lv", "bitwidth":63, "type": "signal", "bundle":{"name": "sext_ln1174", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln1174 { ap_none {  { sext_ln1174 in_data 0 63 } } }
