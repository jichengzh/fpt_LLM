set SynModuleInfo {
  ...
  {SRCNAME activation_accelerator MODELNAME activation_accelerator RTLNAME activation_accelerator IS_TOP 1
    SUBMODULES {
      ...
      {MODELNAME activation_accelerator_activation_accelerator_unsigned_short_unsigned_short_unsigned_short_int_i_19_Ffa RTLNAME activation_accelerator_activation_accelerator_unsigned_short_unsigned_short_unsigned_short_int_i_19_Ffa BINDTYPE storage TYPE ram_2p IMPL uram LATENCY 3 ALLOW_PRAGMA 1}
