...
set C_modelArgList {
	...
	{ exp_x float 32 regular {array 49152 { 0 3 } 0 1 }  }
...
set portList { 
	...
	{ exp_x_address0 sc_out sc_lv 16 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "exp_x_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "exp_x", "role": "address0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.faddfsub_32ns_32ns_32_4_full_dsp_1_U167", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fexp_32ns_32ns_32_8_full_dsp_1_U168", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "147473", "Max" : "147473"}
	, {"Name" : "Interval", "Min" : "147473", "Max" : "147473"}
]}
...
set Spec2ImplPortList { 
	...
	exp_x { ap_memory {  { exp_x_address0 mem_address 1 16 }  { exp_x_ce0 mem_ce 1 1 }  { exp_x_we0 mem_we 1 1 }  { exp_x_d0 mem_din 1 32 } } }
