...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_in0 \
    op interface \
    ports { in0 { I 64 vector } in0_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_s_in01 \
    op interface \
    ports { s_in01_din { O 512 vector } s_in01_full_n { I 1 bit } s_in01_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_s_in12 \
    op interface \
    ports { s_in12_din { O 512 vector } s_in12_full_n { I 1 bit } s_in12_write { O 1 bit } } \
} "
}
