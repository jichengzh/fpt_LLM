set moduleName activation_accelerator_Pipeline_VITIS_LOOP_151_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {activation_accelerator_Pipeline_VITIS_LOOP_151_1}
...
set portList { 
	...
	{ grp_fu_369_p_opcode sc_out sc_lv 1 signal -1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "grp_fu_369_p_opcode", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "grp_fu_369_p_opcode", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "activation_accelerator_Pipeline_VITIS_LOOP_151_1",
		"Protocol" : "ap_ctrl_hs",
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fexp_32ns_32ns_32_8_full_dsp_1_U44", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "32791", "Max" : "32791"}
	, {"Name" : "Interval", "Min" : "32791", "Max" : "32791"}
]}
...
set Spec2ImplPortList { 
	x { ap_memory {  { x_address0 mem_address 1 15 }  { x_ce0 mem_ce 1 1 }  { x_q0 in_data 0 32 } } }
