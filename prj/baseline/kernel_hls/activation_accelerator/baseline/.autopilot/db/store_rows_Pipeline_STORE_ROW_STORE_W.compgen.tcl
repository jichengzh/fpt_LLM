...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln499 \
    op interface \
    ports { sext_ln499 { I 58 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_s_out3 \
    op interface \
    ports { s_out3_dout { I 512 vector } s_out3_num_data_valid { I 7 vector } s_out3_fifo_cap { I 7 vector } s_out3_empty_n { I 1 bit } s_out3_read { O 1 bit } } \
} "
}
