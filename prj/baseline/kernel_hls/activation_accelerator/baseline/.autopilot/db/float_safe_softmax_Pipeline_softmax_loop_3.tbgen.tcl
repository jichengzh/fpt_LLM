set moduleName float_safe_softmax_Pipeline_softmax_loop_3
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {float_safe_softmax_Pipeline_softmax_loop_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ exp_x float 32 regular {array 49152 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ exp_x_address0 sc_out sc_lv 16 signal 0 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fdiv_32ns_32ns_32_9_no_dsp_1_U173", "Parent" : "0"},
...
set Spec2ImplPortList { 
	exp_x { ap_memory {  { exp_x_address0 mem_address 1 16 }  { exp_x_ce0 mem_ce 1 1 }  { exp_x_q0 mem_dout 0 32 } } }
