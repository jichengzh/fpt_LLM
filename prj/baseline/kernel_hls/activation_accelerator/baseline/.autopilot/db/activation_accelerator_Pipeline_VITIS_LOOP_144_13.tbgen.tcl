set moduleName activation_accelerator_Pipeline_VITIS_LOOP_144_13
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {activation_accelerator_Pipeline_VITIS_LOOP_144_13}
set C_modelType { void 0 }
set C_modelArgList {
	{ x float 32 regular {array 32768 { 0 3 } 0 1 }  }
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "activation_accelerator_Pipeline_VITIS_LOOP_144_13",
		"Protocol" : "ap_ctrl_hs",
...
set Spec2ImplPortList { 
	x { ap_memory {  { x_address0 mem_address 1 15 }  { x_ce0 mem_ce 1 1 }  { x_we0 mem_we 1 1 }  { x_d0 mem_din 1 32 } } }
