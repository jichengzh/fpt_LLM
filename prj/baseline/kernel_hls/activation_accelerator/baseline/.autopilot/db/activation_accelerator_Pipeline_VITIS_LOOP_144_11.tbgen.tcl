set moduleName activation_accelerator_Pipeline_VITIS_LOOP_144_11
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {activation_accelerator_Pipeline_VITIS_LOOP_144_11}
set C_modelType { void 0 }
set C_modelArgList {
	{ y float 32 regular {array 32768 { 0 3 } 0 1 }  }
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "activation_accelerator_Pipeline_VITIS_LOOP_144_11",
		"Protocol" : "ap_ctrl_hs",
...
set Spec2ImplPortList { 
	y { ap_memory {  { y_address0 mem_address 1 15 }  { y_ce0 mem_ce 1 1 }  { y_we0 mem_we 1 1 }  { y_d0 mem_din 1 32 } } }
	buf1 { ap_memory {  { buf1_address0 mem_address 1 15 }  { buf1_ce0 mem_ce 1 1 }  { buf1_q0 in_data 0 16 } } }
}
