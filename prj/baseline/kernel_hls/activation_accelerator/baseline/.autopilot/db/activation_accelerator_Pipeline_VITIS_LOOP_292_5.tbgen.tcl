set moduleName activation_accelerator_Pipeline_VITIS_LOOP_292_5
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {activation_accelerator_Pipeline_VITIS_LOOP_292_5}
...
set portList { 
	...
	{ buf2_address0 sc_out sc_lv 15 signal 0 } 
	{ buf2_ce0 sc_out sc_logic 1 signal 0 } 
	{ buf2_we0 sc_out sc_logic 1 signal 0 } 
	{ buf2_d0 sc_out sc_lv 16 signal 0 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "activation_accelerator_Pipeline_VITIS_LOOP_292_5",
		"Protocol" : "ap_ctrl_hs",
		...
		"Loop" : [
			{"Name" : "VITIS_LOOP_292_5", "PipelineType" : "NotSupport"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	activation_accelerator_Pipeline_VITIS_LOOP_292_5 {
		buf2 {Type O LastRead -1 FirstWrite 0}}}
