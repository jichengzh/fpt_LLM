set moduleName activation_accelerator_Pipeline_VITIS_LOOP_316_6
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {activation_accelerator_Pipeline_VITIS_LOOP_316_6}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem2 int 16 regular {axi_master 1}  }
	{ sext_ln316 int 63 regular  }
	{ buf2 int 16 regular {array 32768 { 1 3 } 1 1 } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem2", "interface" : "axi_master", "bitwidth" : 16, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "out_r","offset": { "type": "dynamic","port_name": "out_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln316", "interface" : "wire", "bitwidth" : 63, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln316 sc_in sc_lv 63 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln316", "direction": "in", "datatype": "sc_lv", "bitwidth":63, "type": "signal", "bundle":{"name": "sext_ln316", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "activation_accelerator_Pipeline_VITIS_LOOP_316_6",
		"Protocol" : "ap_ctrl_hs",
		...
		"Loop" : [
			{"Name" : "VITIS_LOOP_316_6", "PipelineType" : "UPC",
...
set Spec2ImplPortList { 
	...
	sext_ln316 { ap_none {  { sext_ln316 in_data 0 63 } } }
	buf2 { ap_memory {  { buf2_address0 mem_address 1 15 }  { buf2_ce0 mem_ce 1 1 }  { buf2_q0 mem_dout 0 16 } } }
}
