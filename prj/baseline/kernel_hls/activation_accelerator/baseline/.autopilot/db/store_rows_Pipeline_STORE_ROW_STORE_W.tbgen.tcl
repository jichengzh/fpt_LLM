set moduleName store_rows_Pipeline_STORE_ROW_STORE_W
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {store_rows_Pipeline_STORE_ROW_STORE_W}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem2 int 512 regular {axi_master 1}  }
	{ sext_ln748 int 58 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem2", "interface" : "axi_master", "bitwidth" : 512, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "out_r","offset": { "type": "dynamic","port_name": "out_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln748", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ s_out3_dout sc_in sc_lv 512 signal 2 } 
	{ s_out3_num_data_valid sc_in sc_lv 7 signal 2 } 
	{ s_out3_fifo_cap sc_in sc_lv 7 signal 2 } 
	{ s_out3_empty_n sc_in sc_logic 1 signal 2 } 
	{ s_out3_read sc_out sc_logic 1 signal 2 } 
	...
	{ sext_ln748 sc_in sc_lv 58 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln748", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "sext_ln748", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln748 { ap_none {  { sext_ln748 in_data 0 58 } } }
