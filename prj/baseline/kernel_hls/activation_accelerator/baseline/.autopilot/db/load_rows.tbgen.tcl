...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "in0","offset": { "type": "dynamic","port_name": "in0","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "in0", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ in1 sc_in sc_lv 64 signal 3 } 
	{ s_in01_din sc_out sc_lv 512 signal 4 } 
	{ s_in01_full_n sc_in sc_logic 1 signal 4 } 
	{ s_in01_write sc_out sc_logic 1 signal 4 } 
	{ s_in12_din sc_out sc_lv 512 signal 5 } 
	{ s_in12_full_n sc_in sc_logic 1 signal 5 } 
	{ s_in12_write sc_out sc_logic 1 signal 5 } 
	{ ap_clk sc_in sc_logic 1 clock -1 } 
	{ ap_rst sc_in sc_logic 1 reset -1 active_high_sync } 
	{ in0_ap_vld sc_in sc_logic 1 invld 1 } 
	{ in1_ap_vld sc_in sc_logic 1 invld 3 } 
...
set NewPortList {[ 
	{ "name": "m_axi_gmem0_AWVALID", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "gmem0", "role": "AWVALID" }} , 
 	...
 	{ "name": "in0", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "in0", "role": "default" }} , 
 	...
 	{ "name": "s_in01_din", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "s_in01", "role": "din" }} , 
 	{ "name": "s_in01_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "s_in01", "role": "full_n" }} , 
 	{ "name": "s_in01_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "s_in01", "role": "write" }} , 
 	{ "name": "s_in12_din", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "s_in12", "role": "din" }} , 
 	...
 	{ "name": "in0_ap_vld", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "in0", "role": "ap_vld" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"InputProcess" : [
			{"ID" : "1", "Name" : "load_rows_Loop_LOAD_ROW_proc1_U0"}],
		"OutputProcess" : [
			{"ID" : "1", "Name" : "load_rows_Loop_LOAD_ROW_proc1_U0"}],
		"Port" : [
			{"Name" : "gmem0", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "load_rows_Loop_LOAD_ROW_proc1_U0", "Port" : "gmem0"}]},
			{"Name" : "in0", "Type" : "None", "Direction" : "I"},
			{"Name" : "gmem1", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "load_rows_Loop_LOAD_ROW_proc1_U0", "Port" : "gmem1"}]},
			{"Name" : "in1", "Type" : "None", "Direction" : "I"},
			{"Name" : "s_in01", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "64", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "load_rows_Loop_LOAD_ROW_proc1_U0", "Port" : "s_in01"}]},
			{"Name" : "s_in12", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "64", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "load_rows_Loop_LOAD_ROW_proc1_U0", "Port" : "s_in12"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.load_rows_Loop_LOAD_ROW_proc1_U0", "Parent" : "0", "Child" : ["2"],
		...
		"Port" : [
			...
			{"Name" : "gmem0", "Type" : "MAXI", "Direction" : "I",
				...
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_load_rows_Loop_LOAD_ROW_proc1_Pipeline_LOAD_ROW_LOAD_W_fu_76", "Port" : "gmem0", "Inst_start_state" : "8", "Inst_end_state" : "9"}]},
			{"Name" : "in1", "Type" : "None", "Direction" : "I"},
			{"Name" : "gmem1", "Type" : "MAXI", "Direction" : "I",
				"BlockSignal" : [
					{"Name" : "gmem1_blk_n_AR", "Type" : "RtlSignal"}],
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_load_rows_Loop_LOAD_ROW_proc1_Pipeline_LOAD_ROW_LOAD_W_fu_76", "Port" : "gmem1", "Inst_start_state" : "8", "Inst_end_state" : "9"}]},
			{"Name" : "s_in01", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "64", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_load_rows_Loop_LOAD_ROW_proc1_Pipeline_LOAD_ROW_LOAD_W_fu_76", "Port" : "s_in01", "Inst_start_state" : "8", "Inst_end_state" : "9"}]},
			{"Name" : "s_in12", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "64", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_load_rows_Loop_LOAD_ROW_proc1_Pipeline_LOAD_ROW_LOAD_W_fu_76", "Port" : "s_in12", "Inst_start_state" : "8", "Inst_end_state" : "9"}]}]},
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.load_rows_Loop_LOAD_ROW_proc1_U0.grp_load_rows_Loop_LOAD_ROW_proc1_Pipeline_LOAD_ROW_LOAD_W_fu_76", "Parent" : "1", "Child" : ["3"],
	...
	{"ID" : "3", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.load_rows_Loop_LOAD_ROW_proc1_U0.grp_load_rows_Loop_LOAD_ROW_proc1_Pipeline_LOAD_ROW_LOAD_W_fu_76.flow_control_loop_pipe_sequential_init_U", "Parent" : "2"}]}
...
set Spec2ImplPortList { 
	...
	in0 { ap_none {  { in0 in_data 0 64 }  { in0_ap_vld in_vld 0 1 } } }
	...
	s_in01 { ap_fifo {  { s_in01_din fifo_port_we 1 512 }  { s_in01_full_n fifo_status 0 1 }  { s_in01_write fifo_data 1 1 } } }
	s_in12 { ap_fifo {  { s_in12_din fifo_port_we 1 512 }  { s_in12_full_n fifo_status 0 1 }  { s_in12_write fifo_data 1 1 } } }
}
