set moduleName activation_accelerator_Pipeline_VITIS_LOOP_190_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {activation_accelerator_Pipeline_VITIS_LOOP_190_2}
...
set portList { 
	...
	{ var_1_out sc_out sc_lv 32 signal 2 } 
	{ var_1_out_ap_vld sc_out sc_logic 1 outvld 2 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "activation_accelerator_Pipeline_VITIS_LOOP_190_2",
		"Protocol" : "ap_ctrl_hs",
		...
		"Loop" : [
			{"Name" : "VITIS_LOOP_190_2", "PipelineType" : "UPC",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "98315", "Max" : "98315"}
	, {"Name" : "Interval", "Min" : "98315", "Max" : "98315"}
]}
