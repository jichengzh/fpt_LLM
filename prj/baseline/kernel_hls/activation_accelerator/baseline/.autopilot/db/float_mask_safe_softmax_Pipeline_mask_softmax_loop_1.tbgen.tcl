set moduleName float_mask_safe_softmax_Pipeline_mask_softmax_loop_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {float_mask_safe_softmax_Pipeline_mask_softmax_loop_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ max_val float 32 regular  }
	{ x_mask float 32 regular {array 1024 { 1 3 } 1 1 }  }
	{ max_val_4_out float 32 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "max_val", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "max_val_4_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ x_mask_address0 sc_out sc_lv 10 signal 1 } 
	{ x_mask_ce0 sc_out sc_logic 1 signal 1 } 
	{ x_mask_q0 sc_in sc_lv 32 signal 1 } 
	{ max_val_4_out sc_out sc_lv 32 signal 2 } 
	{ max_val_4_out_ap_vld sc_out sc_logic 1 outvld 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "max_val_4_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "max_val_4_out", "role": "default" }} , 
 	{ "name": "max_val_4_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "max_val_4_out", "role": "ap_vld" }} , 
...
set Spec2ImplPortList { 
	...
	x_mask { ap_memory {  { x_mask_address0 mem_address 1 10 }  { x_mask_ce0 mem_ce 1 1 }  { x_mask_q0 in_data 0 32 } } }
	max_val_4_out { ap_vld {  { max_val_4_out out_data 1 32 }  { max_val_4_out_ap_vld out_vld 1 1 } } }
}
