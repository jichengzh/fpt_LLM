set moduleName float_mask_safe_softmax_Pipeline_mask_softmax_loop_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {float_mask_safe_softmax_Pipeline_mask_softmax_loop_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ x_mask float 32 regular {array 1024 { 1 3 } 1 1 }  }
	{ max_val_4_reload float 32 regular  }
	{ exp_x float 32 regular {array 1024 { 3 0 } 0 1 }  }
	{ sum_out float 32 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "x_mask", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "max_val_4_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ x_mask_address0 sc_out sc_lv 10 signal 0 } 
	{ x_mask_ce0 sc_out sc_logic 1 signal 0 } 
	{ x_mask_q0 sc_in sc_lv 32 signal 0 } 
	{ max_val_4_reload sc_in sc_lv 32 signal 1 } 
	{ exp_x_address1 sc_out sc_lv 10 signal 2 } 
	{ exp_x_ce1 sc_out sc_logic 1 signal 2 } 
	{ exp_x_we1 sc_out sc_logic 1 signal 2 } 
	{ exp_x_d1 sc_out sc_lv 32 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "x_mask_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "x_mask", "role": "address0" }} , 
 	...
 	{ "name": "max_val_4_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "max_val_4_reload", "role": "default" }} , 
 	...
 	{ "name": "exp_x_we1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "exp_x", "role": "we1" }} , 
 	{ "name": "exp_x_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "exp_x", "role": "d1" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fsub_32ns_32ns_32_4_full_dsp_1_U272", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fexp_32ns_32ns_32_8_full_dsp_1_U274", "Parent" : "0"},
...
set Spec2ImplPortList { 
	x_mask { ap_memory {  { x_mask_address0 mem_address 1 10 }  { x_mask_ce0 mem_ce 1 1 }  { x_mask_q0 mem_dout 0 32 } } }
	max_val_4_reload { ap_none {  { max_val_4_reload in_data 0 32 } } }
	exp_x { ap_memory {  { exp_x_address1 MemPortADDR2 1 10 }  { exp_x_ce1 MemPortCE2 1 1 }  { exp_x_we1 MemPortWE2 1 1 }  { exp_x_d1 MemPortDIN2 1 32 } } }
