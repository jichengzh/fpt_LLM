set moduleName load_rows_Loop_LOAD_ROW_proc1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {load_rows_Loop_LOAD_ROW_proc1}
...
set portList { 
	...
	{ s_in01_num_data_valid sc_in sc_lv 7 signal 4 } 
	{ s_in01_fifo_cap sc_in sc_lv 7 signal 4 } 
	{ s_in01_full_n sc_in sc_logic 1 signal 4 } 
	{ s_in01_write sc_out sc_logic 1 signal 4 } 
	{ s_in12_din sc_out sc_lv 512 signal 5 } 
	{ s_in12_num_data_valid sc_in sc_lv 7 signal 5 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "gmem0", "Type" : "MAXI", "Direction" : "I",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_load_rows_Loop_LOAD_ROW_proc1_Pipeline_LOAD_ROW_LOAD_W_fu_76", "Port" : "gmem0", "Inst_start_state" : "8", "Inst_end_state" : "9"}]},
			{"Name" : "in1", "Type" : "None", "Direction" : "I"},
			{"Name" : "gmem1", "Type" : "MAXI", "Direction" : "I",
				"BlockSignal" : [
					{"Name" : "gmem1_blk_n_AR", "Type" : "RtlSignal"}],
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_load_rows_Loop_LOAD_ROW_proc1_Pipeline_LOAD_ROW_LOAD_W_fu_76", "Port" : "gmem1", "Inst_start_state" : "8", "Inst_end_state" : "9"}]},
			{"Name" : "s_in01", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "64", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_load_rows_Loop_LOAD_ROW_proc1_Pipeline_LOAD_ROW_LOAD_W_fu_76", "Port" : "s_in01", "Inst_start_state" : "8", "Inst_end_state" : "9"}]},
			{"Name" : "s_in12", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "64", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_load_rows_Loop_LOAD_ROW_proc1_Pipeline_LOAD_ROW_LOAD_W_fu_76", "Port" : "s_in12", "Inst_start_state" : "8", "Inst_end_state" : "9"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_load_rows_Loop_LOAD_ROW_proc1_Pipeline_LOAD_ROW_LOAD_W_fu_76", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_load_rows_Loop_LOAD_ROW_proc1_Pipeline_LOAD_ROW_LOAD_W_fu_76.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set PerformanceInfo {[
	...
	, {"Name" : "Interval", "Min" : "1547", "Max" : "1547"}
]}
