...
set C_modelArgList {
	{ y float 32 regular {array 49152 { 0 3 } 0 1 }  }
...
set portList { 
	...
	{ y_address0 sc_out sc_lv 16 signal 0 } 
...
set Spec2ImplPortList { 
	y { ap_memory {  { y_address0 mem_address 1 16 }  { y_ce0 mem_ce 1 1 }  { y_we0 mem_we 1 1 }  { y_d0 mem_din 1 32 } } }
