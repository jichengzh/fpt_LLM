...
$(ObjDir)/activation_accelerator.cpp_pre.cpp.tb.o : activation_accelerator.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling activation_accelerator.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
