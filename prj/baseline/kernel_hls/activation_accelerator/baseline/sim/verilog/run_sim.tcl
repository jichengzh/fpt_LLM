...
if {[file isfile activation_accelerator.autotvin.dat]} {
	file delete -force activation_accelerator.autotvin.dat
}

if {[file isfile activation_accelerator.autotvout.dat]} {
	file delete -force activation_accelerator.autotvout.dat
}
