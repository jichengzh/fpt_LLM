...
`define AUTOTB_DUT      activation_accelerator
`define AUTOTB_DUT_INST AESL_inst_activation_accelerator
`define AUTOTB_TOP      apatb_activation_accelerator_top
`define AUTOTB_LAT_RESULT_FILE "activation_accelerator.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "activation_accelerator.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_activation_accelerator_top
...
parameter LATENCY_ESTIMATION = 401293;
parameter LENGTH_config_r = 1;
parameter LENGTH_gmem0 = 1536;
parameter LENGTH_gmem1 = 1536;
parameter LENGTH_gmem2 = 1536;
