...
module activation_accelerator_activation_accelerator_Pipeline_VITIS_LOOP_316_6 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [63:0] i_1_cast_fu_115_p1;
wire    ap_block_pp0_stage0_01001;
reg   [15:0] i_fu_54;
wire   [15:0] add_ln316_fu_109_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln316_fu_103_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln316_fu_103_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln316_fu_109_p2 = (ap_sig_allocacmp_i_1 + 16'd1);
...
assign buf2_address0 = i_1_cast_fu_115_p1;

assign i_1_cast_fu_115_p1 = ap_sig_allocacmp_i_1;

assign icmp_ln316_fu_103_p2 = ((ap_sig_allocacmp_i_1 == 16'd32768) ? 1'b1 : 1'b0);
...
endmodule //activation_accelerator_activation_accelerator_Pipeline_VITIS_LOOP_316_6
