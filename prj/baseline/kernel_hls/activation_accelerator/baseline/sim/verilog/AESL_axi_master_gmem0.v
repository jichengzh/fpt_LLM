...
//------------------------Parameter----------------------
`define TV_IN_gmem0 "../tv/cdatafile/c.activation_accelerator.autotvin_gmem0.dat"
`define TV_OUT_gmem0 "../tv/rtldatafile/rtl.activation_accelerator.autotvout_gmem0.dat"
...
parameter gmem0_transaction_depth = 32'd 49152;
parameter gmem0_mem_depth = 32'd 24576;
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > gmem0_mem_depth) begin
                $display ("/home/jicz/xushaohui/fpt_LLM/prj/baseline/kernel_hls/activation_accelerator/baseline/sim/verilog/AESL_axi_master_gmem0.v: Write request address %d exceed AXI master gmem0 array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, gmem0_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > gmem0_mem_depth) begin
                $display ("/home/jicz/xushaohui/fpt_LLM/prj/baseline/kernel_hls/activation_accelerator/baseline/sim/verilog/AESL_axi_master_gmem0.v: Read request address %d exceed AXI master gmem0 array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, gmem0_mem_depth); 
                $finish;
            end
...
integer gmem0_port0_fresh_depth[0:15];
integer gmem0_port0_blank_depth[0:15];

initial begin : runtime_depth_init_process
    gmem0_port0_fresh_depth[0] = 49152;
    gmem0_port0_blank_depth[0] = 0;
    gmem0_port0_fresh_depth[1] = 49152;
    gmem0_port0_blank_depth[1] = 0;
    gmem0_port0_fresh_depth[2] = 49152;
    gmem0_port0_blank_depth[2] = 0;
    gmem0_port0_fresh_depth[3] = 49152;
    gmem0_port0_blank_depth[3] = 0;
    gmem0_port0_fresh_depth[4] = 49152;
    gmem0_port0_blank_depth[4] = 0;
    gmem0_port0_fresh_depth[5] = 49152;
    gmem0_port0_blank_depth[5] = 0;
    gmem0_port0_fresh_depth[6] = 49152;
    gmem0_port0_blank_depth[6] = 0;
    gmem0_port0_fresh_depth[7] = 49152;
    gmem0_port0_blank_depth[7] = 0;
    gmem0_port0_fresh_depth[8] = 49152;
    gmem0_port0_blank_depth[8] = 0;
    gmem0_port0_fresh_depth[9] = 49152;
    gmem0_port0_blank_depth[9] = 0;
    gmem0_port0_fresh_depth[10] = 49152;
    gmem0_port0_blank_depth[10] = 0;
    gmem0_port0_fresh_depth[11] = 49152;
    gmem0_port0_blank_depth[11] = 0;
    gmem0_port0_fresh_depth[12] = 49152;
    gmem0_port0_blank_depth[12] = 0;
    gmem0_port0_fresh_depth[13] = 49152;
    gmem0_port0_blank_depth[13] = 0;
    gmem0_port0_fresh_depth[14] = 49152;
    gmem0_port0_blank_depth[14] = 0;
end
//------------------------Read file------------------------ 
...
initial begin : read_file_process 
  ...
  while (trans_depth != 64'h5a5aa5a50f0ff0f0)  begin
      ...
      for(i = 0; i < gmem0_transaction_depth; i = i + 1) begin 
              if (port_idx == 0) begin
                  if (port_read_done[port_idx] == 1'b0 && read_idx == gmem0_port0_fresh_depth[transaction_num]) begin
          ...
          ret = $fread(token_tmp,fp);
                  ...
                  if (port_fill_done[port_idx] == 1'b0 && port_read_done[port_idx] == 1'b1 && read_idx == gmem0_port0_blank_depth[transaction_num]) begin
          ...
          if (i%2 == 1) begin
              case(mem_page)
                  0 : gmem0_mem_0[i/2] = mem_tmp;
                  1 : gmem0_mem_1[i/2] = mem_tmp;
                  2 : gmem0_mem_2[i/2] = mem_tmp;
...
integer gmem0_cur_trans_depth[0:15];

initial begin : out_depth_init_process
    gmem0_cur_trans_depth[0] = 49152;
    gmem0_cur_trans_depth[1] = 49152;
    gmem0_cur_trans_depth[2] = 49152;
    gmem0_cur_trans_depth[3] = 49152;
    gmem0_cur_trans_depth[4] = 49152;
    gmem0_cur_trans_depth[5] = 49152;
    gmem0_cur_trans_depth[6] = 49152;
    gmem0_cur_trans_depth[7] = 49152;
    gmem0_cur_trans_depth[8] = 49152;
    gmem0_cur_trans_depth[9] = 49152;
    gmem0_cur_trans_depth[10] = 49152;
    gmem0_cur_trans_depth[11] = 49152;
    gmem0_cur_trans_depth[12] = 49152;
    gmem0_cur_trans_depth[13] = 49152;
    gmem0_cur_trans_depth[14] = 49152;
end
endmodule
