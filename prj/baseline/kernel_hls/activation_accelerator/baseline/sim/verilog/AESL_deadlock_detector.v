...
reg [15:0] trans_in_cnt_0;// for process AESL_inst_activation_accelerator.entry_proc_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_0 <= 16'h0;
    end
    else if (AESL_inst_activation_accelerator.entry_proc_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_0;// for process AESL_inst_activation_accelerator.entry_proc_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_0 <= 16'h0;
    end
    else if (AESL_inst_activation_accelerator.entry_proc_U0.ap_done == 1'b1 && AESL_inst_activation_accelerator.entry_proc_U0.ap_continue == 1'b1) begin
    ...
    // Process: AESL_inst_activation_accelerator.entry_proc_U0
    ...
    assign proc_0_data_FIFO_blk[0] = 1'b0 | (~AESL_inst_activation_accelerator.entry_proc_U0.out_r_c_blk_n);
    assign proc_0_data_PIPO_blk[0] = 1'b0;
    assign proc_0_start_FIFO_blk[0] = 1'b0 | (~AESL_inst_activation_accelerator.start_for_store_rows_U0_U.if_full_n & AESL_inst_activation_accelerator.entry_proc_U0.ap_start & ~AESL_inst_activation_accelerator.entry_proc_U0.real_start & (trans_in_cnt_0 == trans_out_cnt_0) & ~AESL_inst_activation_accelerator.start_for_store_rows_U0_U.if_read);
    assign proc_0_TLF_FIFO_blk[0] = 1'b0;
    assign proc_0_input_sync_blk[0] = 1'b0;
    assign proc_0_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_0[0] = dl_detect_out ? proc_dep_vld_vec_0_reg[0] : (proc_0_data_FIFO_blk[0] | proc_0_data_PIPO_blk[0] | proc_0_start_FIFO_blk[0] | proc_0_TLF_FIFO_blk[0] | proc_0_input_sync_blk[0] | proc_0_output_sync_blk[0]);
    assign proc_0_data_FIFO_blk[1] = 1'b0 | (~AESL_inst_activation_accelerator.entry_proc_U0.config_r_c_blk_n);
    assign proc_0_data_PIPO_blk[1] = 1'b0;
    assign proc_0_start_FIFO_blk[1] = 1'b0 | (~AESL_inst_activation_accelerator.start_for_compute_rows_U0_U.if_full_n & AESL_inst_activation_accelerator.entry_proc_U0.ap_start & ~AESL_inst_activation_accelerator.entry_proc_U0.real_start & (trans_in_cnt_0 == trans_out_cnt_0) & ~AESL_inst_activation_accelerator.start_for_compute_rows_U0_U.if_read);
    ...
    assign proc_0_input_sync_blk[2] = 1'b0 | (AESL_inst_activation_accelerator.ap_sync_entry_proc_U0_ap_ready & AESL_inst_activation_accelerator.entry_proc_U0.ap_idle & ~AESL_inst_activation_accelerator.ap_sync_load_rows_U0_ap_ready);
    ...
    // Process: AESL_inst_activation_accelerator.load_rows_U0
    ...
    assign proc_1_data_FIFO_blk[0] = 1'b0 | (~AESL_inst_activation_accelerator.load_rows_U0.load_rows_Loop_LOAD_ROW_proc1_U0.grp_load_rows_Loop_LOAD_ROW_proc1_Pipeline_LOAD_ROW_LOAD_W_fu_76.s_in01_blk_n) | (~AESL_inst_activation_accelerator.load_rows_U0.load_rows_Loop_LOAD_ROW_proc1_U0.grp_load_rows_Loop_LOAD_ROW_proc1_Pipeline_LOAD_ROW_LOAD_W_fu_76.s_in12_blk_n);
    ...
    assign proc_1_input_sync_blk[1] = 1'b0 | (AESL_inst_activation_accelerator.ap_sync_load_rows_U0_ap_ready & AESL_inst_activation_accelerator.load_rows_U0.ap_idle & ~AESL_inst_activation_accelerator.ap_sync_entry_proc_U0_ap_ready);
    ...
    // Process: AESL_inst_activation_accelerator.load_rows_U0.load_rows_Loop_LOAD_ROW_proc1_U0
    AESL_deadlock_detect_unit #(5, 2, 1, 1) AESL_deadlock_detect_unit_2 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    // Process: AESL_inst_activation_accelerator.compute_rows_U0
    ...
    assign proc_3_data_FIFO_blk[3] = 1'b0 | (~AESL_inst_activation_accelerator.compute_rows_U0.config_r_blk_n);
    assign proc_3_data_PIPO_blk[3] = 1'b0;
    assign proc_3_start_FIFO_blk[3] = 1'b0 | (~AESL_inst_activation_accelerator.start_for_compute_rows_U0_U.if_empty_n & AESL_inst_activation_accelerator.compute_rows_U0.ap_idle & ~AESL_inst_activation_accelerator.start_for_compute_rows_U0_U.if_write);
    ...
    // Process: AESL_inst_activation_accelerator.store_rows_U0
    ...
    assign proc_4_data_FIFO_blk[0] = 1'b0 | (~AESL_inst_activation_accelerator.store_rows_U0.grp_store_rows_Pipeline_STORE_ROW_STORE_W_fu_66.s_out3_blk_n);
    ...
    assign proc_4_data_FIFO_blk[1] = 1'b0 | (~AESL_inst_activation_accelerator.store_rows_U0.out_r_blk_n);
    assign proc_4_data_PIPO_blk[1] = 1'b0;
    assign proc_4_start_FIFO_blk[1] = 1'b0 | (~AESL_inst_activation_accelerator.start_for_store_rows_U0_U.if_empty_n & AESL_inst_activation_accelerator.store_rows_U0.ap_idle & ~AESL_inst_activation_accelerator.start_for_store_rows_U0_U.if_write);
