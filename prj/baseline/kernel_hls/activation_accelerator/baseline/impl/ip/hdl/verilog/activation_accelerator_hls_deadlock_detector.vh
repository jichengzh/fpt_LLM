...
always @(negedge dl_reset or posedge dl_clock) begin
    ...
    activation_accelerator_hls_deadlock_detect_unit #(5, 0, 3, 3) activation_accelerator_hls_deadlock_detect_unit_0 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_0_start_FIFO_blk[0] = 1'b0 | (~start_for_store_rows_U0_U.if_full_n & entry_proc_U0.ap_start & ~entry_proc_U0.real_start & (trans_in_cnt_0 == trans_out_cnt_0) & ~start_for_store_rows_U0_U.if_read);
    assign proc_0_TLF_FIFO_blk[0] = 1'b0;
    assign proc_0_input_sync_blk[0] = 1'b0;
    assign proc_0_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_0[0] = dl_detect_out ? proc_dep_vld_vec_0_reg[0] : (proc_0_data_FIFO_blk[0] | proc_0_data_PIPO_blk[0] | proc_0_start_FIFO_blk[0] | proc_0_TLF_FIFO_blk[0] | proc_0_input_sync_blk[0] | proc_0_output_sync_blk[0]);
    assign proc_0_data_FIFO_blk[1] = 1'b0 | (~entry_proc_U0.config_r_c_blk_n);
    assign proc_0_data_PIPO_blk[1] = 1'b0;
    assign proc_0_start_FIFO_blk[1] = 1'b0 | (~start_for_compute_rows_U0_U.if_full_n & entry_proc_U0.ap_start & ~entry_proc_U0.real_start & (trans_in_cnt_0 == trans_out_cnt_0) & ~start_for_compute_rows_U0_U.if_read);
    ...
    assign proc_0_input_sync_blk[2] = 1'b0 | (ap_sync_entry_proc_U0_ap_ready & entry_proc_U0.ap_idle & ~ap_sync_load_rows_U0_ap_ready);
    ...
    // Process: load_rows_U0
    activation_accelerator_hls_deadlock_detect_unit #(5, 1, 2, 2) activation_accelerator_hls_deadlock_detect_unit_1 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_1_data_FIFO_blk[0] = 1'b0 | (~load_rows_U0.load_rows_Loop_LOAD_ROW_proc1_U0.grp_load_rows_Loop_LOAD_ROW_proc1_Pipeline_LOAD_ROW_LOAD_W_fu_76.s_in01_blk_n) | (~load_rows_U0.load_rows_Loop_LOAD_ROW_proc1_U0.grp_load_rows_Loop_LOAD_ROW_proc1_Pipeline_LOAD_ROW_LOAD_W_fu_76.s_in12_blk_n);
    ...
    assign proc_1_input_sync_blk[1] = 1'b0 | (ap_sync_load_rows_U0_ap_ready & load_rows_U0.ap_idle & ~ap_sync_entry_proc_U0_ap_ready);
    ...
    // Process: load_rows_U0.load_rows_Loop_LOAD_ROW_proc1_U0
    activation_accelerator_hls_deadlock_detect_unit #(5, 2, 1, 1) activation_accelerator_hls_deadlock_detect_unit_2 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_2_data_FIFO_blk[0] = 1'b0 | (~load_rows_U0.load_rows_Loop_LOAD_ROW_proc1_U0.grp_load_rows_Loop_LOAD_ROW_proc1_Pipeline_LOAD_ROW_LOAD_W_fu_76.s_in01_blk_n) | (~load_rows_U0.load_rows_Loop_LOAD_ROW_proc1_U0.grp_load_rows_Loop_LOAD_ROW_proc1_Pipeline_LOAD_ROW_LOAD_W_fu_76.s_in12_blk_n);
    ...
    // Process: compute_rows_U0
    activation_accelerator_hls_deadlock_detect_unit #(5, 3, 4, 4) activation_accelerator_hls_deadlock_detect_unit_3 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_3_data_FIFO_blk[0] = 1'b0 | (~compute_rows_U0.grp_compute_rows_Pipeline_UNPK_W_fu_787.s_in01_blk_n) | (~compute_rows_U0.grp_compute_rows_Pipeline_UNPK_W_fu_787.s_in12_blk_n);
    ...
    assign proc_3_data_FIFO_blk[1] = 1'b0 | (~compute_rows_U0.grp_compute_rows_Pipeline_UNPK_W_fu_787.s_in01_blk_n) | (~compute_rows_U0.grp_compute_rows_Pipeline_UNPK_W_fu_787.s_in12_blk_n);
    ...
    assign proc_3_data_FIFO_blk[2] = 1'b0 | (~compute_rows_U0.grp_compute_rows_Pipeline_PK_W_fu_1713.s_out3_blk_n);
    ...
    assign proc_3_data_FIFO_blk[3] = 1'b0 | (~compute_rows_U0.config_r_blk_n);
    assign proc_3_data_PIPO_blk[3] = 1'b0;
    assign proc_3_start_FIFO_blk[3] = 1'b0 | (~start_for_compute_rows_U0_U.if_empty_n & compute_rows_U0.ap_idle & ~start_for_compute_rows_U0_U.if_write);
    ...
    // Process: store_rows_U0
    activation_accelerator_hls_deadlock_detect_unit #(5, 4, 2, 2) activation_accelerator_hls_deadlock_detect_unit_4 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_4_data_FIFO_blk[0] = 1'b0 | (~store_rows_U0.grp_store_rows_Pipeline_STORE_ROW_STORE_W_fu_66.s_out3_blk_n);
    ...
    assign proc_4_data_FIFO_blk[1] = 1'b0 | (~store_rows_U0.out_r_blk_n);
    assign proc_4_data_PIPO_blk[1] = 1'b0;
    assign proc_4_start_FIFO_blk[1] = 1'b0 | (~start_for_store_rows_U0_U.if_empty_n & store_rows_U0.ap_idle & ~start_for_store_rows_U0_U.if_write);
