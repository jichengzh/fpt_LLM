set SynModuleInfo {
  ...
  {SRCNAME {float_safe_softmax3<64, 768>_Pipeline_step_loop} MODELNAME float_safe_softmax3_64_768_Pipeline_step_loop RTLNAME activation_accelerator_float_safe_softmax3_64_768_Pipeline_step_loop}
  ...
  {SRCNAME f32_to_bf16_rne MODELNAME f32_to_bf16_rne RTLNAME activation_accelerator_f32_to_bf16_rne}
  {SRCNAME f32_expf MODELNAME f32_expf RTLNAME activation_accelerator_f32_expf
    SUBMODULES {
      {MODELNAME activation_accelerator_fexp_32ns_32ns_32_8_full_dsp_0 RTLNAME activation_accelerator_fexp_32ns_32ns_32_8_full_dsp_0 BINDTYPE op TYPE fexp IMPL fulldsp LATENCY 7 ALLOW_PRAGMA 1}
    }
  }
  {SRCNAME bf16add_fast MODELNAME bf16add_fast RTLNAME activation_accelerator_bf16add_fast}
  {SRCNAME {float_safe_softmax3<64, 768>_Pipeline_exp_and_bucket} MODELNAME float_safe_softmax3_64_768_Pipeline_exp_and_bucket RTLNAME activation_accelerator_float_safe_softmax3_64_768_Pipeline_exp_and_bucket
    SUBMODULES {
  ...
  {SRCNAME {float_safe_softmax3<64, 768>_Pipeline_step_loop1} MODELNAME float_safe_softmax3_64_768_Pipeline_step_loop1 RTLNAME activation_accelerator_float_safe_softmax3_64_768_Pipeline_step_loop1
    SUBMODULES {
