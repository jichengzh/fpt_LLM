set SynModuleInfo {
  ...
  {SRCNAME activation_accelerator_Pipeline_lane_reduce_softmax MODELNAME activation_accelerator_Pipeline_lane_reduce_softmax RTLNAME activation_accelerator_activation_accelerator_Pipeline_lane_reduce_softmax}
