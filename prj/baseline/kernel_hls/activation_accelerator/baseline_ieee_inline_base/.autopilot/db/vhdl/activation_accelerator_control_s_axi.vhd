...
entity activation_accelerator_control_s_axi is
generic (
...
architecture behave of activation_accelerator_control_s_axi is
    ...
    constant ADDR_IN0_DATA_0      : INTEGER := 16#10#;
    constant ADDR_IN0_DATA_1      : INTEGER := 16#14#;
    constant ADDR_IN0_CTRL        : INTEGER := 16#18#;
    constant ADDR_IN1_DATA_0      : INTEGER := 16#1c#;
    constant ADDR_IN1_DATA_1      : INTEGER := 16#20#;
    constant ADDR_IN1_CTRL        : INTEGER := 16#24#;
    constant ADDR_OUT_R_DATA_0    : INTEGER := 16#28#;
    constant ADDR_OUT_R_DATA_1    : INTEGER := 16#2c#;
    constant ADDR_OUT_R_CTRL      : INTEGER := 16#30#;
    constant ADDR_STAGE_DATA_0    : INTEGER := 16#34#;
    constant ADDR_STAGE_CTRL      : INTEGER := 16#38#;
    constant ADDR_CONFIG_R_DATA_0 : INTEGER := 16#3c#;
    constant ADDR_CONFIG_R_CTRL   : INTEGER := 16#40#;
    ...
    signal int_in0             : UNSIGNED(63 downto 0) := (others => '0');
    signal int_in1             : UNSIGNED(63 downto 0) := (others => '0');
    signal int_out_r           : UNSIGNED(63 downto 0) := (others => '0');
    signal int_stage           : UNSIGNED(31 downto 0) := (others => '0');
    signal int_config_r        : UNSIGNED(31 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_IN0_DATA_0 =>
                        rdata_data <= RESIZE(int_in0(31 downto 0), 32);
                    when ADDR_IN0_DATA_1 =>
                        rdata_data <= RESIZE(int_in0(63 downto 32), 32);
                    ...
                    when ADDR_STAGE_DATA_0 =>
                        rdata_data <= RESIZE(int_stage(31 downto 0), 32);
                    when ADDR_CONFIG_R_DATA_0 =>
                        rdata_data <= RESIZE(int_config_r(31 downto 0), 32);
                    when others =>
                        NULL;
                    end case;
                end if;
...
-- ----------------------- Register logic ----------------
    ...
    in0                  <= STD_LOGIC_VECTOR(int_in0);
    in1                  <= STD_LOGIC_VECTOR(int_in1);
    out_r                <= STD_LOGIC_VECTOR(int_out_r);
    stage                <= STD_LOGIC_VECTOR(int_stage);
    config_r             <= STD_LOGIC_VECTOR(int_config_r);
