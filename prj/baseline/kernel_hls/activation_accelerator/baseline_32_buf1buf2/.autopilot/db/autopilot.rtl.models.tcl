set SynModuleInfo {
  ...
  {SRCNAME f32_to_bf16_array MODELNAME f32_to_bf16_array RTLNAME activation_accelerator_f32_to_bf16_array
    SUBMODULES {
      {MODELNAME activation_accelerator_sparsemux_9_2_32_1_1 RTLNAME activation_accelerator_sparsemux_9_2_32_1_1 BINDTYPE op TYPE sparsemux IMPL compactencoding_dontcare}
    }
  }
  ...
  {SRCNAME activation_accelerator_Pipeline_normalize_blocks_rms_norm3_1 MODELNAME activation_accelerator_Pipeline_normalize_blocks_rms_norm3_1 RTLNAME activation_accelerator_activation_accelerator_Pipeline_normalize_blocks_rms_norm3_1}
  ...
  {SRCNAME activation_accelerator MODELNAME activation_accelerator RTLNAME activation_accelerator IS_TOP 1
    SUBMODULES {
      ...
      {MODELNAME activation_accelerator_activation_accelerator_unsigned_short_unsigned_short_unsigned_short_int_i_29_lbW RTLNAME activation_accelerator_activation_accelerator_unsigned_short_unsigned_short_unsigned_short_int_i_29_lbW BINDTYPE storage TYPE ram IMPL auto LATENCY 2 ALLOW_PRAGMA 1}
