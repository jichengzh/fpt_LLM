...
module activation_accelerator_activation_accelerator_Pipeline_VITIS_LOOP_409_4 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [1:0] trunc_ln410_fu_186_p1;
reg   [1:0] trunc_ln410_reg_244;
wire   [15:0] tmp_fu_195_p6;
reg   [15:0] tmp_reg_249;
wire   [63:0] zext_ln410_fu_178_p1;
wire    ap_block_pp0_stage0_01001;
reg   [15:0] i_fu_68;
wire   [15:0] add_ln409_fu_162_p2;
wire    ap_loop_init;
reg   [15:0] ap_sig_allocacmp_i_1;
wire   [12:0] lshr_ln_fu_168_p4;
reg    ap_done_reg;
...
activation_accelerator_mux_42_16_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 16 ),
    .din1_WIDTH( 16 ),
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln409_fu_156_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln409_fu_156_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln409_fu_156_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign activation_accelerator_unsigned_short_unsigned_short_unsigned_short_int_i_1_address0 = zext_ln410_fu_178_p1;

assign activation_accelerator_unsigned_short_unsigned_short_unsigned_short_int_i_2_address0 = zext_ln410_fu_178_p1;

assign activation_accelerator_unsigned_short_unsigned_short_unsigned_short_int_i_3_address0 = zext_ln410_fu_178_p1;

assign activation_accelerator_unsigned_short_unsigned_short_unsigned_short_int_i_address0 = zext_ln410_fu_178_p1;

assign add_ln409_fu_162_p2 = (ap_sig_allocacmp_i_1 + 16'd1);
...
assign icmp_ln409_fu_156_p2 = ((ap_sig_allocacmp_i_1 == 16'd32768) ? 1'b1 : 1'b0);

assign lshr_ln_fu_168_p4 = {{ap_sig_allocacmp_i_1[14:2]}};
...
assign m_axi_gmem2_WDATA = tmp_reg_249;
...
assign trunc_ln410_fu_186_p1 = ap_sig_allocacmp_i_1[1:0];

assign zext_ln410_fu_178_p1 = lshr_ln_fu_168_p4;

endmodule //activation_accelerator_activation_accelerator_Pipeline_VITIS_LOOP_409_4
