...
module activation_accelerator_activation_accelerator_Pipeline_VITIS_LOOP_368_3 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [15:0] add_ln368_fu_156_p2;
reg   [15:0] add_ln368_reg_203;
wire    ap_CS_fsm_state2;
wire   [0:0] icmp_ln368_fu_150_p2;
reg   [12:0] lshr_ln_reg_218;
wire   [1:0] trunc_ln370_fu_178_p1;
reg   [1:0] trunc_ln370_reg_223;
reg   [15:0] buf0_load_reg_227;
wire    ap_CS_fsm_state3;
reg   [15:0] buf1_load_reg_232;
wire    grp_bf16add_fu_132_ap_start;
wire    grp_bf16add_fu_132_ap_done;
wire    grp_bf16add_fu_132_ap_idle;
wire    grp_bf16add_fu_132_ap_ready;
wire   [15:0] grp_bf16add_fu_132_ap_return;
reg    grp_bf16add_fu_132_ap_start_reg;
wire    ap_CS_fsm_state4;
wire    ap_CS_fsm_state5;
wire   [63:0] zext_ln368_fu_162_p1;
wire   [63:0] zext_ln370_fu_182_p1;
reg   [15:0] i_fu_50;
reg   [4:0] ap_NS_fsm;
...
initial begin
#0 ap_CS_fsm = 5'd1;
#0 grp_bf16add_fu_132_ap_start_reg = 1'b0;
end

activation_accelerator_bf16add grp_bf16add_fu_132(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_bf16add_fu_132_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state4)) begin
            grp_bf16add_fu_132_ap_start_reg <= 1'b1;
        end else if ((grp_bf16add_fu_132_ap_ready == 1'b1)) begin
            grp_bf16add_fu_132_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        i_fu_50 <= 16'd0;
    end else if (((grp_bf16add_fu_132_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln368_fu_150_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        lshr_ln_reg_218 <= {{i_fu_50[14:2]}};
        trunc_ln370_reg_223 <= trunc_ln370_fu_178_p1;
    end
end

always @ (*) begin
    if (((grp_bf16add_fu_132_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (*) begin
    if (((grp_bf16add_fu_132_ap_done == 1'b1) & (trunc_ln370_reg_223 == 2'd2) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (*) begin
    if (((grp_bf16add_fu_132_ap_done == 1'b1) & (trunc_ln370_reg_223 == 2'd1) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (*) begin
    if (((grp_bf16add_fu_132_ap_done == 1'b1) & (trunc_ln370_reg_223 == 2'd0) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (*) begin
    if (((grp_bf16add_fu_132_ap_done == 1'b1) & (trunc_ln370_reg_223 == 2'd3) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (*) begin
    if ((grp_bf16add_fu_132_ap_done == 1'b0)) begin
...
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b0)) | ((icmp_ln368_fu_150_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((icmp_ln368_fu_150_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
assign activation_accelerator_unsigned_short_unsigned_short_unsigned_short_int_i_1_address0 = zext_ln370_fu_182_p1;

assign activation_accelerator_unsigned_short_unsigned_short_unsigned_short_int_i_1_d0 = grp_bf16add_fu_132_ap_return;

assign activation_accelerator_unsigned_short_unsigned_short_unsigned_short_int_i_2_address0 = zext_ln370_fu_182_p1;

assign activation_accelerator_unsigned_short_unsigned_short_unsigned_short_int_i_2_d0 = grp_bf16add_fu_132_ap_return;

assign activation_accelerator_unsigned_short_unsigned_short_unsigned_short_int_i_3_address0 = zext_ln370_fu_182_p1;

assign activation_accelerator_unsigned_short_unsigned_short_unsigned_short_int_i_3_d0 = grp_bf16add_fu_132_ap_return;

assign activation_accelerator_unsigned_short_unsigned_short_unsigned_short_int_i_address0 = zext_ln370_fu_182_p1;

assign activation_accelerator_unsigned_short_unsigned_short_unsigned_short_int_i_d0 = grp_bf16add_fu_132_ap_return;

assign add_ln368_fu_156_p2 = (i_fu_50 + 16'd1);
...
assign buf0_address0 = zext_ln368_fu_162_p1;

assign buf1_address0 = zext_ln368_fu_162_p1;

assign grp_bf16add_fu_132_ap_start = grp_bf16add_fu_132_ap_start_reg;

assign icmp_ln368_fu_150_p2 = ((i_fu_50 == 16'd32768) ? 1'b1 : 1'b0);

assign trunc_ln370_fu_178_p1 = i_fu_50[1:0];

assign zext_ln368_fu_162_p1 = i_fu_50;

assign zext_ln370_fu_182_p1 = lshr_ln_reg_218;

endmodule //activation_accelerator_activation_accelerator_Pipeline_VITIS_LOOP_368_3
