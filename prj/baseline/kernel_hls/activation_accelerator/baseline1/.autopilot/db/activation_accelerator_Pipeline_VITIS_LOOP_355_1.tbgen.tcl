set moduleName activation_accelerator_Pipeline_VITIS_LOOP_355_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {activation_accelerator_Pipeline_VITIS_LOOP_355_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem0 int 16 regular {axi_master 0}  }
	{ sext_ln355 int 63 regular  }
	{ buf0 int 16 regular {array 32768 { 0 3 } 0 1 } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "in0","offset": { "type": "dynamic","port_name": "in0","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln355", "interface" : "wire", "bitwidth" : 63, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln355 sc_in sc_lv 63 signal 1 } 
	{ buf0_address0 sc_out sc_lv 15 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln355", "direction": "in", "datatype": "sc_lv", "bitwidth":63, "type": "signal", "bundle":{"name": "sext_ln355", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln355 { ap_none {  { sext_ln355 in_data 0 63 } } }
	buf0 { ap_memory {  { buf0_address0 mem_address 1 15 }  { buf0_ce0 mem_ce 1 1 }  { buf0_we0 mem_we 1 1 }  { buf0_d0 mem_din 1 16 } } }
}
