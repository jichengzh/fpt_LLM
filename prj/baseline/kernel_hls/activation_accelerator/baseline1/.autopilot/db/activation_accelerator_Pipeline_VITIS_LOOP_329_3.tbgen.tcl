set moduleName activation_accelerator_Pipeline_VITIS_LOOP_329_3
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {activation_accelerator_Pipeline_VITIS_LOOP_329_3}
...
set C_modelArgList {
	...
	{ max_val_18_reload float 32 regular  }
	{ exp_x float 32 regular {array 32768 { 0 3 } 0 1 }  }
	{ sum_34_out float 32 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "x", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "max_val_18_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "exp_x", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "sum_34_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ max_val_18_reload sc_in sc_lv 32 signal 4 } 
	{ exp_x_address0 sc_out sc_lv 15 signal 5 } 
	{ exp_x_ce0 sc_out sc_logic 1 signal 5 } 
	{ exp_x_we0 sc_out sc_logic 1 signal 5 } 
	{ exp_x_d0 sc_out sc_lv 32 signal 5 } 
	{ sum_34_out sc_out sc_lv 32 signal 6 } 
	{ sum_34_out_ap_vld sc_out sc_logic 1 outvld 6 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "max_val_18_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "max_val_18_reload", "role": "default" }} , 
 	...
 	{ "name": "sum_34_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "sum_34_out", "role": "default" }} , 
 	{ "name": "sum_34_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "sum_34_out", "role": "ap_vld" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_42_32_1_1_U124", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "98321", "Max" : "98321"}
	, {"Name" : "Interval", "Min" : "98321", "Max" : "98321"}
]}
...
set Spec2ImplPortList { 
	...
	max_val_18_reload { ap_none {  { max_val_18_reload in_data 0 32 } } }
	exp_x { ap_memory {  { exp_x_address0 mem_address 1 15 }  { exp_x_ce0 mem_ce 1 1 }  { exp_x_we0 mem_we 1 1 }  { exp_x_d0 mem_din 1 32 } } }
	sum_34_out { ap_vld {  { sum_34_out out_data 1 32 }  { sum_34_out_ap_vld out_vld 1 1 } } }
}
