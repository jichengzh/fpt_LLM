set moduleName activation_accelerator_Pipeline_VITIS_LOOP_358_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {activation_accelerator_Pipeline_VITIS_LOOP_358_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem1 int 16 regular {axi_master 0}  }
	{ sext_ln358 int 63 regular  }
	{ buf1 int 16 regular {array 32768 { 0 3 } 0 1 } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "in1","offset": { "type": "dynamic","port_name": "in1","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln358", "interface" : "wire", "bitwidth" : 63, "direction" : "READONLY"} , 
 	{ "Name" : "buf1", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ sext_ln358 sc_in sc_lv 63 signal 1 } 
	{ buf1_address0 sc_out sc_lv 15 signal 2 } 
	{ buf1_ce0 sc_out sc_logic 1 signal 2 } 
	{ buf1_we0 sc_out sc_logic 1 signal 2 } 
	{ buf1_d0 sc_out sc_lv 16 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln358", "direction": "in", "datatype": "sc_lv", "bitwidth":63, "type": "signal", "bundle":{"name": "sext_ln358", "role": "default" }} , 
 	...
 	{ "name": "buf1_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "buf1", "role": "we0" }} , 
 	{ "name": "buf1_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "buf1", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln358 { ap_none {  { sext_ln358 in_data 0 63 } } }
	buf1 { ap_memory {  { buf1_address0 mem_address 1 15 }  { buf1_ce0 mem_ce 1 1 }  { buf1_we0 mem_we 1 1 }  { buf1_d0 mem_din 1 16 } } }
}
