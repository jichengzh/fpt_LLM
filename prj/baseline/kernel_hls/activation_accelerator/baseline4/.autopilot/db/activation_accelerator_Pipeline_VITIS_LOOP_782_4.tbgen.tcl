set moduleName activation_accelerator_Pipeline_VITIS_LOOP_782_4
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {activation_accelerator_Pipeline_VITIS_LOOP_782_4}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem2 int 16 regular {axi_master 1}  }
	{ sext_ln782 int 63 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem2", "interface" : "axi_master", "bitwidth" : 16, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "out_r","offset": { "type": "dynamic","port_name": "out_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln782", "interface" : "wire", "bitwidth" : 63, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln782 sc_in sc_lv 63 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln782", "direction": "in", "datatype": "sc_lv", "bitwidth":63, "type": "signal", "bundle":{"name": "sext_ln782", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		"CDFG" : "activation_accelerator_Pipeline_VITIS_LOOP_782_4",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "sext_ln782", "Type" : "None", "Direction" : "I"},
		...
		"Loop" : [
			{"Name" : "VITIS_LOOP_782_4", "PipelineType" : "UPC",
...
set ArgLastReadFirstWriteLatency {
	activation_accelerator_Pipeline_VITIS_LOOP_782_4 {
		gmem2 {Type O LastRead -1 FirstWrite 2}
		sext_ln782 {Type I LastRead 0 FirstWrite -1}
...
set Spec2ImplPortList { 
	...
	sext_ln782 { ap_none {  { sext_ln782 in_data 0 63 } } }
