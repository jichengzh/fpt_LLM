set SynModuleInfo {
  ...
  {SRCNAME float_safe_softmax3_Pipeline_reduce_partial MODELNAME float_safe_softmax3_Pipeline_reduce_partial RTLNAME activation_accelerator_float_safe_softmax3_Pipeline_reduce_partial
    SUBMODULES {
  ...
  {SRCNAME float_safe_softmax3_Pipeline_normalize_blocks MODELNAME float_safe_softmax3_Pipeline_normalize_blocks RTLNAME activation_accelerator_float_safe_softmax3_Pipeline_normalize_blocks
    SUBMODULES {
      ...
      {MODELNAME activation_accelerator_mux_83_32_1_1 RTLNAME activation_accelerator_mux_83_32_1_1 BINDTYPE op TYPE mux IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
    }
  }
