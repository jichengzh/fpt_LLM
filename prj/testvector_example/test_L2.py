...
N, D = 64, 768
path_output= "/home/xushaohui/FPT/fpt_LLM/prj/testvector_example/bf16_vectors/hls_output_config_" + config + ".bin"
path_golden = "/home/xushaohui/FPT/fpt_LLM/prj/testvector_example/bf16_vectors/golden_out_config_"+ config + "_bf16.bin"
...
df_nandif_out.to_csv("/home/xushaohui/FPT/fpt_LLM/prj/seedata_inline/config_"+ config +"/df_nandif_out_config_"+ config +".csv", index=False, header=False)  # index=False 去掉行号，header=False 去掉列名
df_nandif_gold.to_csv("/home/xushaohui/FPT/fpt_LLM/prj/seedata_inline/config_"+ config +"/df_nandif_gold_config_"+ config +".csv", index=False, header=False)  # index=False 去掉行号，header=False 去掉列名
...
df_infdif_out.to_csv("/home/xushaohui/FPT/fpt_LLM/prj/seedata_inline/config_"+ config +"/df_infdif_out_config_"+ config +".csv", index=False, header=False)  # index=False 去掉行号，header=False 去掉列名
df_infdif_gold.to_csv("/home/xushaohui/FPT/fpt_LLM/prj/seedata_inline/config_"+ config +"/df_infdif_gold_config_"+ config +".csv", index=False, header=False)  # index=False 去掉行号，header=False 去掉列名
df_infdif_sign.to_csv("/home/xushaohui/FPT/fpt_LLM/prj/seedata_inline/config_"+ config +"/df_infdif_sign_config_"+ config +".csv", index=False, header=False)  # index=False 去掉行号，header=False 去掉列名
...
#输出使用进位算法的结果
df_error.to_csv("/home/xushaohui/FPT/fpt_LLM/prj/seedata_inline/config_"+ config +"/errors_per_row_config_"+ config +"_round.csv", index=False, header=False)  # index=False 去掉行号，header=False 去掉列名
df_error_point.to_csv("/home/xushaohui/FPT/fpt_LLM/prj/seedata_inline/config_"+ config +"/errors_point_per_row_config_"+ config +"_round.csv", index=False, header=False)  # index=False 去掉行号，header=False 去掉列名
